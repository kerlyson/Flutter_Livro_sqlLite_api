...
class DataBase {
  ...
  initDB() async {
    ...
    String path = pathUtil.join(documentsDirectory.path, "livros_db");

    return await sqflite.openDatabase(path, version: 1, onOpen: (bd){}, onCreate: (sqflite.Database db, int version) async{
